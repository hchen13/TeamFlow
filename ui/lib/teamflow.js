...
const larkUserScopes = "bitable:app base:app:read base:table:read base:table:create base:table:update base:field:read base:field:create base:field:update base:view:read base:view:write_only base:record:read base:record:retrieve base:record:create base:record:update base:record:delete docs:event:subscribe docs:permission.member:auth docs:permission.member:create drive:drive.metadata:readonly offline_access";
